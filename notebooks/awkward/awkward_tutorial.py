...
#
# For more details, see [array classes](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc).
#
#   * [Jaggedness](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#jaggedness)
#    * [JaggedArray](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#jaggedarray)
#    * [Helper functions](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#helper-functions)
#   * [Product types](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#product-types)
#    * [Table](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#table)
#   * [Sum types](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#sum-types)
#    * [UnionArray](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#unionarray)
#   * [Option types](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#option-types)
#    * [MaskedArray](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#maskedarray)
#    * [BitMaskedArray](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#bitmaskedarray)
#    * [IndexedMaskedArray](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#indexedmaskedarray)
#   * [Indirection](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#indirection)
#    * [IndexedArray](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#indexedarray)
#    * [SparseArray](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#sparsearray)
#    * [Helper functions](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#helper-functions-1)
#   * [Opaque objects](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#opaque-objects)
#    * [Mix-in Methods](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#mix-in-methods)
#    * [ObjectArray](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#objectarray)
#    * [StringArray](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#stringarray)
#   * [Non-contiguousness](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#non-contiguousness)
#    * [ChunkedArray](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#chunkedarray)
#    * [AppendableArray](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#appendablearray)
#   * [Laziness](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#laziness)
#    * [VirtualArray](https://github.com/scikit-hep/awkward-array/blob/master/docs/classes.adoc#virtualarray)
...
#
# [Apache Arrow](https://arrow.apache.org) is a cross-language, columnar memory format for complex data structures. There is intentionally a high degree of overlap between awkward-array and Arrow. But whereas Arrow's focus is data portability, awkward's focus is computation: it would not be unusual to get data from Arrow, compute something with awkward-array, then return it to another Arrow buffer. For this reason, `awkward.fromarrow` is a zero-copy view. Awkward's data representation is broader than Arrow's, so `awkward.toarrow` does, in general, perform a copy.
#
...
#
# More detail on the row-wise to columnar conversion process is given in [docs/fromiter.adoc](https://github.com/scikit-hep/awkward-array/blob/master/docs/fromiter.adoc).
...
#
# The same serialization format is used when you pickle an awkward array or save it in an HDF5 file. More detail on the metadata mini-language is given in [docs/serialization.adoc](https://github.com/scikit-hep/awkward-array/blob/master/docs/serialization.adoc).
...
# %% [markdown]
# * `awkward.fromarrow(arrow, awkwardlib=None)`: convert an [Apache Arrow](https://arrow.apache.org) formatted buffer to an awkward array (zero-copy). The `awkwardlib` parameter has the same meaning as above.
#
