...
#
# [joblib](https://github.com/joblib/joblib) Provides the best way to run naively parallel jobs on multiple threads or processes in python.
#
# * It integrates seamlessly with [dask](https://distributed.dask.org/en/latest/)
...
# %% [markdown]
# ### Running a threadsafe function using numba to release the GIL
...
# %%
logging.basicConfig(
    level=logging.DEBUG, format="%(message)s %(threadName)s %(processName)s",
)
