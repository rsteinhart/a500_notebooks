...
######
    def save_ncattr(key):
        ...
        try:
            ...
            for ncattr in nc_fid.variables[key].ncattrs():
                save_dict[ncattr]=repr(nc_fid.variables[key].getncattr(ncattr))
        except KeyError:
            save_dict=None
            the_dtype=None
        ...
        for group_name, group in groups:
            ...
            for var in nc_vars:
                if var not in nc_dims:
                    ...
                    the_group[var]['dimensions'] = group.variables[var].dimensions
...
def make_parser():
    ...
    parser.add_argument('--outfile', type=str, default='attributes.json', help='path to output json file file to hold attribute info')
    return parser
